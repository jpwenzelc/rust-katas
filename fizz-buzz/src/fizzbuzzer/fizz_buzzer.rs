...
mod tests {
    ...
    #[case(4)]
    #[case(7)]
    fn that_retuns_a_number_if_not_divisible_by_3_or_5(#[case] input: i32) {
    ...
    #[case(9)]
    #[case(12)]
    fn that_retuns_fizz_if_is_divisible_by_3(#[case] input: i32) {
        let result = fizz_buzzer(input);
    ...
    #[case(20)]
    #[case(25)]
    fn that_retuns_buzz_if_is_divisible_by_5(#[case] input: i32) {
        let result = fizz_buzzer(input);
    ...
    #[case(30)]
    #[case(45)]
    fn that_retuns_fizzbuzz_if_is_divisible_by_3_and_5(#[case] input: i32) {
        let result = fizz_buzzer(input);
